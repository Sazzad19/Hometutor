...
<div class="container">
 ...
 <div class="alert alert-success">
  <p>{{$message}}</p>
    ...
    @endif
<div class="row" >
<div class="col-md-8 mb-10" style="margin-top: 40px;">
    <div class="card" >
    <div class="card-header" style="background-color: #2c312e; color: white;">
        <div class="text-center">
          <h5 class="text-center">Tuition Form</h5>
            <strong >
            Request for a tutor! </strong> If you want to get your Desired tutor then fill the below form.
                    </div>
                </div>
                   ...
                   <form method="post" action="{{route('guardian.storetuition')}}" data-select2-id="19">
                                ...
                                @endforeach
                                 ...
                                 <div class="form-group">
                                  <label for="exampleFormControlInput1"><strong>Title</strong></label>
                                   <input type="text" name="title"  value="" placeholder="Type title of the post" class="form-control poshytip">
                                 </div>
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-row">
                                    <div class="form-group col-md-6">
                                      <label for="exampleFormControlInput1"><strong> Student Gender</strong></label>
                                      ...
                                      <div class="form-group col-md-6">
                                        <label for="inputPassword4"><strong>Student Institution</strong></label> <input type="text" name="s_college"  placeholder="Type institution name" class="form-control poshytip">
                                      </div>
                                    </div>
                                     ...
                                     <div class="form-row">
                                      ...
                                      <div class="col-md-4 mb-10" style="margin-top: 40px;">
                                        <div class="card">
                                            <h5 class="bg-custom text-light py-3 pl-3" style="background-color: #2c312e; ">HELP &amp; INFO</h5>
                                             <div class="p-2" style="background-color: #dcece4; ">
                                                <strong>Q. How can i get my prospective tutor ?</strong>
                                                 <p class="mt-1 text-secondary" style="color: black;">
                     ...
                     <strong>Q. What will happen after submit the form ?</strong>
                      <p class="mt-1 text-secondary text-justify">
                       Available tutors will contact with you.
                    </p>
                </div>
            </div> 
