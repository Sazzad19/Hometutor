                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-row">
                                    <div class="form-group col-md-6">
                                      ...
                                      <div class="form-group col-md-6">
                                        <label for="inputPassword4"><strong>Student Institute</strong></label> <input type="text" name="s_college"  placeholder="Type Institute name" class="form-control poshytip">
                                      </div>
                                    </div>
