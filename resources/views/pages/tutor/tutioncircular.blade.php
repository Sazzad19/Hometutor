...
<div class="text-center">
		...
		<div class="text-center"> <button type="button" class="btn btn-success" data-toggle="modal" data-target="#apply_{{$i}}" style="width: 100px; margin-bottom: 10px;">Apply</button>  </div>

      {{--   <div class="text-center"> <button type="button" class="btn btn-success" id="apply"  style="width: 100px; margin-bottom: 10px;">Apply</button>  </div>--}}
...
@endforeach
			...
			<div class="pull-right mt-2 mb-5 d-none d-sm-block"><ul role="navigation" class="pagination">
     <li>
       <span aria-hidden="true" class="page-link">{{$tuitions->links()}}</span>
...
<form class="form-inline md-form mr-auto mb-4" action="{{route('tutor.search')}}" method="get" style="margin-left: 32px;">
   {{ csrf_field() }}
  ...
  <input class="form-control mr-sm-2" type="text" placeholder="District" name="district">
